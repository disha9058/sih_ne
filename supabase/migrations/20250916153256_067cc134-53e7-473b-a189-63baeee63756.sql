...
('Jorhat Tea Estate', 'Coliform', '15 CFU/100ml', 'Unsafe', CURRENT_DATE - INTERVAL '1 day'),
('Dibrugarh Village', 'pH Level', '7.2', 'Safe', CURRENT_DATE - INTERVAL '2 days'),
('Silchar Market Area', 'Turbidity', '8 NTU', 'Needs Attention', CURRENT_DATE - INTERVAL '3 days'),
('Majuli Island', 'Arsenic', '0.08 mg/L', 'Unsafe', CURRENT_DATE - INTERVAL '4 days');
...
-- Sample alerts (checking allowed severity values)
